...
public class TestAtelier1 {
	...
	public static void main(String[] args) {
		...
		/* Test revealedCard() */
		hand.revealCard(1);
		System.out.println("Après revealCard(1) : " + hand);	// Après revealeCard(1) : [[?-?, Roi-Carreau]]
		hand.revealCard(6);
		System.out.println("Après revealCard(6) : " + hand);	// Après revealeCard(6) : [[?-?, Roi-Carreau]]
		hand.revealCard(0);
		System.out.println("Après revealCard(0) : " + hand);	// Après revealeCard(0) : [[2-Carreau, Roi-Carreau]]
		...
		/* Test hideCard(), revealCard(), playCard() */
		p1.hideCard(0);
